...
def Register():
    ...
    Quit = tk.Button(Reg, text = "Quit", width="10", command = Reg.master.destroy, bd = '3',  font = ('Times', 12, 'bold'), bg='black', fg='white',relief='groove', justify = 'center', pady='5')
    Quit.place(anchor ='sw',rely=1,relx=0.84)
    
    Back = tk.Button(Reg, text = "Back", width="10", command = Reg.destroy, bd = '3',  font = ('Times', 12, 'bold'), bg='black', fg='white',relief='groove', justify = 'center', pady='5')
    Back.place(anchor ='se',rely=1,relx=0.775)

    footer=Label(Reg, bg="white",text="Document Classification version 1.0",fg="black",font="Leelawadee 11")
    footer.place(height=30,width=400,x=190, y=667)
    Reg.mainloop()
